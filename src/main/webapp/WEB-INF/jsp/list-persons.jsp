					...
					<c:forEach items="${requestScope.list}" var="person">
						<tr>
							<form action="/add-person/update">
								...
								<td><input style="width: 40%" class="btn btn-success" type="submit" value="update"/><input style="width: 40%" class="btn btn-warning" type="button" onclick="location.href='/add-person/delete?id=${person.id}'" value="delete"></td>
							</form>
						</tr>
					</c:forEach>
				</tbody>
